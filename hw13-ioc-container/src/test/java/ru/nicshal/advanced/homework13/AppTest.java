...
import ru.nicshal.advanced.homework13.appcontainer.api.AppComponent;
import ru.nicshal.advanced.homework13.appcontainer.api.AppComponentsContainerConfig;
import ru.nicshal.advanced.homework13.config.AppConfig;
import ru.nicshal.advanced.homework13.services.*;
...
class AppTest {
    ...
    @CsvSource(
            value = {
                    "GameProcessor, ru.nicshal.advanced.homework13.services.GameProcessor",
                    "GameProcessorImpl, ru.nicshal.advanced.homework13.services.GameProcessor",
                    "gameProcessor, ru.nicshal.advanced.homework13.services.GameProcessor",
                    "IOService, ru.nicshal.advanced.homework13.services.IOService",
                    "IOServiceStreams, ru.nicshal.advanced.homework13.services.IOService",
                    "ioService, ru.nicshal.advanced.homework13.services.IOService",
                    "PlayerService, ru.nicshal.advanced.homework13.services.PlayerService",
                    "PlayerServiceImpl, ru.nicshal.advanced.homework13.services.PlayerService",
                    "playerService, ru.nicshal.advanced.homework13.services.PlayerService",
                    "EquationPreparer, ru.nicshal.advanced.homework13.services.EquationPreparer",
                    "EquationPreparerImpl, ru.nicshal.advanced.homework13.services.EquationPreparer",
                    "equationPreparer, ru.nicshal.advanced.homework13.services.EquationPreparer"
            })
    void shouldExtractFromContextCorrectComponentWithNotNullFields(String classNameOrBeanId, Class<?> rootClass)
        ...
        if (classNameOrBeanId.charAt(0) == classNameOrBeanId.toUpperCase().charAt(0)) {
            Class<?> gameProcessorClass = Class.forName("ru.nicshal.advanced.homework13.services." + classNameOrBeanId);
